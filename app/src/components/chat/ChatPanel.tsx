...
const styles: Record<string, React.CSSProperties> = {
    ...
    bubble: {
        ...
        fontSize: '16px',
        lineHeight: '1.5',
        boxShadow: '0 10px 18px rgba(47, 42, 36, 0.10)',
        wordWrap: 'break-word',
    },
    userBubble: {
    ...
    systemMessage: {
        margin: '8px auto',
        padding: '8px 16px',
        backgroundColor: 'rgba(185, 162, 122, 0.15)',
        color: '#8E7A56',
        fontSize: '0.85rem',
        borderRadius: '12px',
        textAlign: 'center',
        maxWidth: '90%',
        whiteSpace: 'pre-wrap',
        border: '1px solid rgba(185, 162, 122, 0.3)',
    },
    content: {
...
const markdownStyles: Record<string, React.CSSProperties> = {
    ...
    hr: {
        border: 'none',
        borderTop: '1px solid rgba(216, 207, 193, 0.6)',
        margin: '16px 0',
    },
};
